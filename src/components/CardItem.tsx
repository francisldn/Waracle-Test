  ...
  return (
    <article className='flex flex-col rounded-xl w-[95%] mx-auto overflow-hidden border-gray-300 border-2 shadow-gray-800 mb-4 box-effect'>
      ...
      <div className='flex gap-2 mx-6 my-4 flex-wrap'>
        {temperament.split(",").map((el) => (
          <div
            key={el}
            className='bg-[#dbe4ff] text-xl rounded-2xl px-2 py-1 border-[1px] border-black'
          >
            {el}
          </div>
        ))}
      ...
      <a
        ...
        className='px-6 text-xl pb-2 text-blue-500 font-semibold'
      >
        Learn more
      </a>
    </article>
